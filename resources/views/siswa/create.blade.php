        ...
        <div class="card-body">
            ...
            <form action="{{ route('siswa.store') }}" method="POST" onsubmit="return validasiForm()">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="NRP" id="NRP" maxlength="10" class="form-control"
                            value="{{ old('NRP') }}">
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Nama" id="Nama" maxlength="20" class="form-control"
                            value="{{ old('Nama') }}">
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="Kelas" id="Kelas" maxlength="5" class="form-control"
                            value="{{ old('Kelas') }}">
                    </div>
                </div>
                <div class="row mb-3">
